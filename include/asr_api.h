...
RecogRetCode recognizer_attachContextDecoder(void* base, const char* decoder_name, _Bool bSlot);
...
/////////////////////////////////////////////////////////////////////////////////////////////////
//session api
RecogRetCode recognizer_createSession(void** session, void* base, UInt32 sample_rate);
...
RecogRetCode recognizer_startSession_LongRec(void* session, const Int32 nThreadIndex);
...
RecogRetCode recognizer_stopSession(void* session);
